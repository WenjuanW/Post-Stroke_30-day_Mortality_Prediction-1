...
Sex <- array(sample(c(0,1), n, replace = TRUE)) 
...
validation_sample <- cbind(Age_Groups_by5, Sex,
                           ...
                           nihss_arrival,
                           type_of_stroke.Primary.Intracerebral.Haemorrhage,type_of_stroke.Unknown,mortality_30_day)


write.csv(validation_sample,"validation_sample.csv")
